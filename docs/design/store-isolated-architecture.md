...
Expose metrics through platform-neutral Prometheus/health interfaces. Define names together with the existing-metric migration mapping before implementation.
